...
if __name__ == "__main__":
    ...
    finetuned_unet_name_or_path = "../STEP2-DiffusionModel/l2_cat_df4_noblur/checkpoint-56000"
    ...
    # input_image=(input_image*1).astype(np.uint8)
    # print(input_image.min(), input_image.max(), input_image.dtype)
